...
public class Recepcionista implements Observable {
    ...
    private boolean isEmpleadosEnOficina() {
        return empleados.size() > 0 ? true : false;
    }

    public void cuentaCopucha(String copucha, Observer empleado) {
        if( isEmpleadosEnOficina()){
            setChanged();
    ...
    public int countHowManyPeopleNotified(){
